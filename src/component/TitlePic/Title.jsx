...
<div className={"md:flex md:flex-row flex flex-col-reverse justify-between mt-2 items-center font-bold"}>
  ...
  <div className={"typing-demo text-gray-800 w-[95%] md:w-full md:text-[40px] text-[25px]"}>ما به هر قیمتی
دوره تولید نمی کنیم!
  </div>
        <div>
        ...
        <div className={"mt-14 md:mt-20 mx-auto w-[75%] md:mx-auto text-center"}>
            ...
            <button className={"button-53 mx-auto md:w-[75%] w-[80%] font-bold"} role="button"> همین حالا شروع کنید!</button>
